...
@Slf4j
@Service
public class TaiyangSpiderServiceImpl implements SpiderService {

    private static final String URL = "https://www.tyhttp.com/free/page";
